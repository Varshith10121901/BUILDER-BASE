...
<!-- 
    ...
    Include all HTML, CSS, and JavaScript
    Make sure to keep the triple quotes above and below
-->
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("\nINSTRUCTIONS:")
    print("1. Paste your complete HTML code between the triple quotes")
    print("   in the HTML_TEMPLATE variable at the top of this file")
    print("2. Make sure your HTML includes all CSS and JavaScript")
    print("3. Update API calls in your HTML to use:")
